...
The Ghostwriter: A response-synthesis engine that uses the patient’s past letters and values to suggest comforting answers to repetitive, difficult questions.
...
Contextual Retrieval: The system queries the Spatio-Temporal Knowledge Graph to identify the current "Identity Era".

Synthesis: The LLM generates a localized "suture" based on caregiver-defined Narrative Synthesis (milestones, mending style, and safe harbors).
...
"Ensure personhood outlasts the memory."
